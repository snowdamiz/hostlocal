...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            runtime_boundary::runtime_pause_issue_run,
            runtime_boundary::runtime_resume_issue_run,
            runtime_boundary::runtime_abort_issue_run,
            runtime_boundary::runtime_steer_issue_run,
